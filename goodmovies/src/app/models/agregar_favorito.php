...
$sql = "INSERT INTO favoritos (IDuSUARIO, IDpELICULA) VALUES (?, ?)";
...
if ($stmt) {
    ...
    if ($stmt->affected_rows > 0) {
        $response = array('status' => 'success', 'message' => 'Película añadida a favoritos correctamente');
    } else {
        $response = array('status' => 'error', 'message' => 'Error al agregar la película a favoritos');
    }
