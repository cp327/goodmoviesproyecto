...
document.addEventListener('DOMContentLoaded', function () {
    // Obtener la ruta de los resultados de búsqueda desde el servidor
    var rutaCompleta = '../models/resultado.json';

    // Realizar la solicitud para obtener los datos de búsqueda
    fetch(rutaCompleta)
