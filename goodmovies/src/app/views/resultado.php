...
$rutaJson = '../models/resultado.json';
...
if (file_exists($rutaJson)) {
    ...
    // Decodificar el JSON y almacenarlo en la variable $peliculas
    $peliculas = json_decode($contenidoJson, true);
} else {
    // Manejar el caso en el que el archivo no existe o no se puede leer
    $peliculas = array();
}
?>
    <div class="overlay">
...
<div class="banner">
    <div class="swiper bannerSwiper">
        <div class="swiper-wrapper">
            <?php 
            // Iterar sobre las películas del JSON
            foreach ($peliculas as $pelicula) {
            ?>
            <div class="swiper-slide">
                <img src="<?php echo $pelicula['imgFondo']; ?>" alt="">
            </div>
            <?php 
            } 
            ?>
...
if (file_exists($rutaJson)) {
    ...
    // Decodificar el JSON y almacenarlo en la variable $descripcion
    $descripcion = json_decode($contenidoJson, true);
} else {
    // Manejar el caso en el que el archivo no existe o no se puede leer
    $descripcion = array();
}
...
<div class="content-fijo">
        ...
        <div class="thumbs">
            <div thumbsSlider="" class="swiper thumbsSwiper">
                ...
                <div class="swiper-wrapper pene"> 
                    ...
                    foreach ($descripcion as $pelicula) {
                    ?>
                    <div class="swiper-slide">     
                        <img src="<?php echo $pelicula['imgPortada']; ?>" alt="">
                    </div>
                    <?php 
                    } 
                    ?>
    ...
    <script defer src="../controllers/scriptBusqueda.js"></script>
    <script src="../controllers/scriptNavbarHome.js"></script>
    <script  src="../controllers/agregarFavorito.js"></script>
    <script src="../controllers/agregarDescarga.js"></script>
