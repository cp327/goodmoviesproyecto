    ...
    <div class="banner">
        ...
        <div class="swiper bannerSwiper">
            ...
            <div class="swiper-wrapper">
                ...
                FROM descargas d
                INNER JOIN peliculasgm ON d.IDpELICULA = peliculasgm.IDpELICULA
...
<div class="position-content">
    <div class="content">
        ...
        <div class="description">
            ...
            <button class="btn-primary" onclick="eliminarDeDescargas()" id="btnDescargas" data-idpelicula="">
...
<div class="content-fijo">
    ...
    <script defer src="../controllers/scriptDescargas.js"></script>
    <script  src="../controllers/agregarFavorito.js"></script>
    <script defer src="../controllers/eliminarDescarga.js"></script>
