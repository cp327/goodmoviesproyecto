...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Determinar la ruta base en función del nombre del archivo
  var rutaBase = nombreArchivo === 'admin' ? 'models/' : '../models/';

  // Si no es admin, usar el nombre del archivo como categoría
  var categoria = nombreArchivo === 'home.php' || nombreArchivo === 'admin' ? '' : nombreArchivo.replace('.php', '');

  // Concatenar la ruta base con el nombre del archivo PHP
  var rutaCompleta = rutaBase + 'generar_descripcion.php' + (categoria ? '?categoria=' + categoria : '');
